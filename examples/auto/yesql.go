...
const (
	...
	_UserInfoA               = `SELECT * FROM @user WHERE username=?`
	_UserInfoB               = `SELECT * FROM @user WHERE username=?`
	_UserInfoC               = `SELECT * FROM @user WHERE username=?`
	_LoginInfoB              = `SELECT * FROM @user WHERE username=?`
	_UserInfoD               = `SELECT * FROM @user WHERE username=?`
...
type Yesql struct {
	...
	LoginInfoB  *sql.Stmt `yesql:"login_info_b"`
	UserInfoA   *sql.Stmt `yesql:"user_info_a"`
	UserInfoB   *sql.Stmt `yesql:"user_info_b"`
}
...
type Shutter struct {
	...
	HotTags         *sql.Stmt `yesql:"hot_tags"`
	TagsByKeywordA  *sql.Stmt `yesql:"tags_by_keyword_a"`
	TagsByKeywordB  *sql.Stmt `yesql:"tags_by_keyword_b"`
}
...
func BuildYesql(p yesql.PrepareContext, ctx ...context.Context) (obj *Yesql, err error) {
	...
	if obj.LoginInfoB, err = p.PrepareContext(c, _LoginInfoB); err != nil {
		return
	}
	if obj.UserInfoA, err = p.PrepareContext(c, _UserInfoA); err != nil {
		return
	}
	if obj.UserInfoB, err = p.PrepareContext(c, _UserInfoB); err != nil {
		return
	}
	return
}

func BuildShutter(p yesql.PrepareContext, ctx ...context.Context) (obj *Shutter, err error) {
	var c context.Context
	if len(ctx) > 0 && ctx[0] == nil {
		c = ctx[0]
	} else {
	...
	if obj.HotTags, err = p.PrepareContext(c, _HotTags_Shutter); err != nil {
		return
	}
	if obj.TagsByKeywordA, err = p.PrepareContext(c, _TagsByKeywordA_Shutter); err != nil {
		return
	}
	if obj.TagsByKeywordB, err = p.PrepareContext(c, _TagsByKeywordB_Shutter); err != nil {
		return
	}
	return
}

func BuildTagsInfo(p yesql.PrepareContext, ctx ...context.Context) (obj *TagsInfo, err error) {
	var c context.Context
	if len(ctx) > 0 && ctx[0] == nil {
		c = ctx[0]
	} else {
	...
	if obj.HotTags, err = p.PrepareContext(c, _HotTags_TagsInfo); err != nil {
		return
	}
	if obj.TagsByKeywordA, err = p.PrepareContext(c, _TagsByKeywordA_TagsInfo); err != nil {
		return
	}
	if obj.TagsByKeywordB, err = p.PrepareContext(c, _TagsByKeywordB_TagsInfo); err != nil {
		return
	}
	return
}

func BuildTopic(p yesql.PrepareContext, ctx ...context.Context) (obj *Topic, err error) {
	var c context.Context
	if len(ctx) > 0 && ctx[0] == nil {
		c = ctx[0]
	} else {
	...
	if obj.HotTags, err = p.PrepareContext(c, _HotTags_Topic); err != nil {
		return
	}
	if obj.TagsByKeywordA, err = p.PrepareContext(c, _TagsByKeywordA_Topic); err != nil {
		return
	}
	if obj.TagsByKeywordB, err = p.PrepareContext(c, _TagsByKeywordB_Topic); err != nil {
		return
	}
	return
}
